...
#The actual access token is not written here since it is a public repository
def extract_project_PRs(project_full_name):
    ...
    while True:
        try:
            ...
            continue
        break
    df_PRs.to_csv('Dataset5.csv', sep=',', encoding='utf-8', index=True)

extract_project_PRs('akveo/ngx-admin')
